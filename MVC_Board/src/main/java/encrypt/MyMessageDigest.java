...
public class MyMessageDigest {
	...
	public String hashing(String strPlainTexyt) {
		...
		try {
			...
			System.out.println(hashAlgorithm + " 이 존재하지 않습니다.");
			e.printStackTrace();
		}
